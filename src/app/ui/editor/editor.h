...
public:
  enum EditorFlags {
    ...
    kShowSlices = 64,
    kDefaultEditorFlags = (kShowGrid | kShowMask | kShowOnionskin | kShowOutside | kShowDecorators |
  ...
  EditorCustomizationDelegate* getCustomizationDelegate() { return m_customizationDelegate; }
  ...
  void showMouseCursor(ui::CursorType cursorType, const ui::Cursor* cursor = nullptr);
